...
offspring = 2
couples = np.loadtxt('iev.txt')
couples = couples * offspring
dominantProba = np.array([[1, 1, 1, 0.75, 0.5, 0]])

couples = couples * dominantProba

result = couples.sum()

print('Number of {} offsprings displaying the dominant phenotype is expected'.format(result))